...
import image_1 from "../../Assests/image 1.png";

export default function Header() {
  return (
    <header>
      <nav className="bg-white border-gray-200 px-5 py-2 pl-5">
        <div className="flex flex-wrap justify-between items-center">
          <div className="flex items-center bg-[#F5F5F5] rounded-md">
            ...
            <input
              className="w-80 rounded-md bg-[#F5F5F5] text-[#787486] h-44px leading-tight focus:outline-none py-2 px-2 border-radius:6px text-base:14px"
              type="text"
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center mx-5">
              <div className="flex flex-col mr-4">
                <div>
                  <h3 className="text-[#0D062D] font-normal text-md whitespace-nowrap">
                    Anima Agrawal
                  </h3>
                </div>
                <div className="self-end">
                  <h5 style={{ fontSize: 14, color: "#787486" }}>U.P, India</h5>
                </div>
              </div>
              <div className="flex justify-between items-center">
                <div className="mr-1">
