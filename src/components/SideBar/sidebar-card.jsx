const SidebarCard = () => {
  return (
    <div className="hidden sm:block w-[230px] h-[200px] rounded-2xl mx-auto mt-[85px] p-4 bg-gray-100 relative ml-8">
      <div className="w-[66px] h-[66px] rounded-full bg-gray-100 absolute top-[-33px] left-[86px] ">
        <div className="top-[-17.5px] left-[-17.5px] absolute">
          <svg
            width="101"
            height="101"
            viewBox="0 0 101 101"
